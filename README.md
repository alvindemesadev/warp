...
<a href="https://github.com/alvindemesadev/warp/releases/download/v1.2.2/WarpDemo.mp4"><img src="https://github.com/alvindemesadev/warp/raw/main/docs/screenshot.png" alt="Watch demo - click to play" width="640" /></a>
...
|---|---|---|
| `docs/Warp_1.2.2_x64-setup.exe` | 4.7 MB | Windows installer (recommended) |
| `docs/Warp_1.2.2_x64_en-US.msi` | 6.3 MB | MSI installer |
...
Output installer:
```
src-tauri/target/release/bundle/nsis/Warp_1.2.2_x64-setup.exe
```
