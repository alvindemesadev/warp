...
[![Version](https://img.shields.io/badge/Version-1.1.0-339dff.svg)](https://github.com/alvindemesadev/warp/releases)
...
Output installer:
```
src-tauri/target/release/bundle/nsis/Warp_1.1.0_x64-setup.exe
```
