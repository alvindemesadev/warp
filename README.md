...
[![Version](https://img.shields.io/badge/Version-1.1.3-339dff.svg)](https://github.com/alvindemesadev/warp/releases)
...
|---|---|---|
| `docs/Warp_1.1.3_x64-setup.exe` | 4.6 MB | Windows installer (recommended) |
| `docs/Warp_1.1.3_x64_en-US.msi` | 6.3 MB | MSI installer |
...
Output installer:
```
src-tauri/target/release/bundle/nsis/Warp_1.1.3_x64-setup.exe
```
